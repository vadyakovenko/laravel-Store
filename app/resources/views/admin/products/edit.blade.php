                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 color">
                                            ...
                                            <p>В магазине:
                                                ...
                                                <button data-variant="{{ $variant->id }}" class="btn btn-xs btn-warning change-color {{ !$variant->color ? 'hidden' : '' }}" data-toggle="modal" data-target="#colors"><i class="fa fa-pencil"></i> Изменить</button>
                                                <button data-variant="{{ $variant->id }}" class="btn btn-xs btn-danger add-color {{ $variant->color ? 'hidden' : '' }}" data-toggle="modal" data-target="#colors"><i class="fa fa-plus"></i> Добавить</button>
                                            </p>
