...
@section('content')
    <div class="box">
        <form method="POST" action="{{route('admin.characteristics.sizes.update', $size)}}">
            @method('PUT')
            @csrf
            ...
            <div class="box-body">
                <div class="col-md-4">
                    <div class="form-group {{!$errors->has('value') ? : 'has-error'}}">
                        ...
                        <input type="text" class="form-control" id="value" name="value" value="{{ $size->value}}" placeholder="Название">
